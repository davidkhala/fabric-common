...
- [chaincode] Chaincode invoker `creator` could belongs to differed organization than target peers
...
- [chaincode][system] System chaincodes are designed to be invoked by a client rather than by a user chaincode. Invoking from a user chaincode may cause deadlocks.
